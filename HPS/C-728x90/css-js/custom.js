...
mtl.set(banner, {visibility: "visible"}) 
	...
	// Frame1 animation
	.addLabel("f1")
	.to(".bg", 8, {scale:1, rotation:0.2, ease: Sine.easeOut}, "f1")
	...
	.to(".txt1b", .5, {alpha:0, rotation:0.2, ease: Sine.easeOut}, "f1+=1.75")
	.to(".txt1-bg", .5, {width:0, rotation:0.2, ease: Sine.easeOut}, "f1+=1.75")
	.from(".txt2-bg", .75, {width: 0, ease: Sine.easeOut}, "f1+=2.25")
	.from(".txt2b", .5, {alpha: 0, rotation:0.2, ease: Sine.easeOut}, "f1+=2.65")
	...
	.to("#frame_one", .5, {y:-90, rotation:0.02, ease: Expo.easeOut}, "f1+=7")
