...
tl1.set(banner, {visibility: "visible"})
    ...
    .fromTo(".kid", 1.5, {scale:0.85,transformOrigin:"bottom center"},{scale :1, x:0, transformOrigin:"bottom center", rotation:0.02, ease: Linear.easeInOut}, "label+=1")
    ...
    .to(".bg", 6, {scale :1.43, y:55, x:-48, transformOrigin:"center", ease: Linear.easeNone, rotation:0.02}, "label+=1")
