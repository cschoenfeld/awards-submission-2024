...
mtl.set(banner, {visibility: "visible"})
   ...
   .addLabel("f2", "f1+=4.5")
   .from(".txt1", .75, {alpha:0, y:15, ease: Sine.easeOut, stagger:0.2}, "f2")
   .from(".cta-txt", .5, {alpha:0, ease: Sine.easeOut}, "f2+=1.25")
   .from(".txt2", .75, {alpha:0, y:10, ease: Sine.easeOut, stagger:0.2}, "f2+=1.25")       
   .from(".bg2", .75, {alpha:0, ease: Sine.easeOut}, "f2+=1.5")       
;
