...
tl1.set(banner, {visibility: "visible"})
    ...
    .fromTo(".kid", 1.5, {scale:0.92,transformOrigin:"bottom center"},{scale :1.02, x:-5, transformOrigin:"bottom center", rotation:0.02, ease: Linear.easeInOut}, "label+=1")
    ...
    .from(".copy4", 0.5, {autoAlpha:0, y:15, ease: Sine.easeOut, rotation:0.02}, "label+=01.1")
