...
mtl.set(banner, {visibility: "visible"})
   ...
   .from(".gaze", 0.75, {alpha:0, ease: Sine.easeOut}, "f1+=0.25")
   .to(".gaze img", 3, {y:-4230, ease: "steps(47)"}, "f1+=0.25")

   .add("f2", "f1+=3")
   .to(".bg1Box, .gaze", 1, {xPercent:-100, rotation:0.1, ease:Expo.easeInOut}, "f2")
   ...
   .from(".discover", 0.75, {alpha:0, ease: Sine.easeOut}, "f2+=.75")
   .to(".discover img", 3, {y:-4230, ease: "steps(47)"}, "f2+=.75")

   .add("f3", "f2+=3")
   .to(".bg2Box, .discover", 1, {xPercent:-100, rotation:0.1, ease:Expo.easeInOut}, "f3")
   ...
   .from(".launch", 0.75, {alpha:0, ease: Sine.easeOut}, "f3+=.75")
   .to(".launch img", 3, {y:-4230, ease: "steps(47)"}, "f3+=.75")

   .add("f4", "f3+=3")
   .to(".launch", 1, {xPercent:-100, ease:Expo.easeInOut}, "f4")
