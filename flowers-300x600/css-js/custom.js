...
tl1.set(banner, {visibility: "visible"})
    ...
    .fromTo(".kid", 1.5, {scale:0.92,transformOrigin:"bottom center"},{scale :1.02, x:0, transformOrigin:"bottom center", rotation:0.02, ease: Linear.easeInOut}, "label+=1")
    .from(".copy1", 0.5, {autoAlpha:0, y:15, ease: Sine.easeOut, rotation:0.02}, "label+=0.5")
    .from(".copy2", 0.5, {autoAlpha:0, y:15, ease: Sine.easeOut, rotation:0.02}, "label+=0.7")
    .from(".copy3", 0.5, {autoAlpha:0, y:15, ease: Sine.easeOut, rotation:0.02}, "label+=0.9")
    ...
    .from(".copy4", 0.3, {autoAlpha:0, y:9, ease: Sine.easeOut,rotation:0.02}, "label+=5")
    .from(".copy5", 0.3, {autoAlpha:0, y:10, ease: Sine.easeOut, rotation:0.02}, "label+=5.3")
